...
function getTodos() {
    fetch('https://cinematrix.onrender.com/users', {
        method: 'GET',
...
todosTable.addEventListener('click', (event) => {
    ...
    if (event.target.classList.contains('deleteTodoBtn')) {
        ...
        fetch(`https://cinematrix.onrender.com/users/${todoId}`, {
            method: 'DELETE',
            // credentials: 'include' ,
            headers: {
                // "cookie":`token=${token}`
...
loginForm.addEventListener('submit', function (event) {
    ...
    // ...
    if (email && password != "") {
        fetch("https://cinematrix.onrender.com/register", {
            method: "POST",
...
function getDoctorTodos() {
    fetch('https://cinematrix.onrender.com/api/movies-with-shows', {
        method: 'GET',
        //  credentials: 'same-origin' 
        headers: {
            // cookie: `token=${localStorage.getItem("token")}`
...
doctortodosTable.addEventListener('click', (event) => {
    ...
    if (event.target.classList.contains('deleteTodoBtn')) {
        const todoId = (event.target.dataset.id);
        // console.log(localStorage.getItem("token"));
        fetch(`https://cinematrix.onrender.com/api/movies/${todoId}`, {
            method: 'DELETE',
            // credentials: 'include' ,
            headers: {
                // "cookie":`token=${token}`
...
loginDForm.addEventListener('submit', function (event) {
    ...
    if (description && genre && image && title != "") {
        fetch("https://cinematrix.onrender.com/api/movies", {
            method: "POST",
            headers: {
...
loginSForm.addEventListener('submit', function (event) {
    ...
    if (timings && categories && movie_id != "") {
        fetch(`https://cinematrix.onrender.com/api/movies/${formDataObject.movie_id}/shows`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
                // , Authorization: localStorage.getItem("token") 
